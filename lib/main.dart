...
class _HomePageState extends State<HomePage> with SingleTickerProviderStateMixin {
  ...
  Widget _buildInputSection(String title, String subtitle, TextEditingController controller, String hintText, {int maxLines = 1, bool isRequired = false}) {
    return Column(
      ...
      children: [
        ...
        SizedBox(height: 4),
        Text(subtitle, style: TextStyle(color: Colors.white, fontWeight: FontWeight.w600, fontSize: 24)),
        SizedBox(height: 8),
  ...
  Widget _buildInputField(String label, TextEditingController controller, String hintText, {int maxLines = 1, bool isRequired = false}) {
    return TextFormField(
      ...
      maxLines: maxLines,
      style: TextStyle(color: Colors.white, fontWeight: FontWeight.w600, fontSize: 20), // Increased by 10
      decoration: InputDecoration(
        labelText: label,
        labelStyle: TextStyle(color: Colors.grey[400], fontWeight: FontWeight.w600, fontSize: 20), // Increased by 10
        hintText: hintText,
        hintStyle: TextStyle(color: Colors.grey[600], fontWeight: FontWeight.w600, fontSize: 20), // Increased by 10
        fillColor: Colors.black,
        filled: true,
        border: OutlineInputBorder(
          borderSide: BorderSide(color: Color(0xFF262629), width: 2),
    ...
    return DefaultTabController(
      ...
      child: Column(
        children: [
          TabBar(
            tabs: [
              Tab(child: GradientText('Version 1', gradient: _versionGradient, style: TextStyle(fontSize: 25, fontWeight: FontWeight.w600))),
              Tab(child: GradientText('Version 2', gradient: _versionGradient, style: TextStyle(fontSize: 25, fontWeight: FontWeight.w600))),
              Tab(child: GradientText('Version 3', gradient: _versionGradient, style: TextStyle(fontSize: 25, fontWeight: FontWeight.w600))),
            ],
